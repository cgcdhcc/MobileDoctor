...
/**
 * 需要在style里面添加这些xml <style name="XDialog" parent="@android:style/Theme.Dialog">
 * <item name="android:windowBackground">@android:color/transparent</item> <item
 * name="android:windowFrame">@null</item> <item
 ...
 * name="android:windowAnimationStyle">@style/DialogAnimation</item> <item
 * name="android:background">@android:color/transparent</item> <item
 * name="android:backgroundDimEnabled">true</item> <item
 * name="android:windowFullscreen">true</item> </style>
 * 
 * <style name="DialogAnimation" parent="@android:style/Animation.Dialog"> <item
 * name="android:windowEnterAnimation">@anim/push_up_in</item> <item
 * name="android:windowExitAnimation">@anim/push_down_out</item> </style>
 */
