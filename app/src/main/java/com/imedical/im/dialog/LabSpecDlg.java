...
public class LabSpecDlg extends Dialog {
    public DocOrderActivity activity;
    public List<LabSpec> labSpecList;
    public ListView lv_data;
    public LabSpecDlg(DocOrderActivity activity, List<LabSpec> labSpecList) {
        super(activity, R.style.quick_option_dialog);
        this.activity=activity;
        this.labSpecList=labSpecList;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.docorder_labspec_dlg);
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                dismiss();
                activity.setLabSpec(labSpecList.get(i));
            }
        });
    }
    class PriorityAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            tv_value.setText(labSpecList.get(i).labSpec);
            return view;
        }
    }
}
