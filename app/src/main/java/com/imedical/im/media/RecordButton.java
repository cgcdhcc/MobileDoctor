...
public class RecordButton extends Button {
	...
	private static final int MIN_INTERVAL_TIME = 500;// 2s
	...
	private static int[] res = { R.drawable.record_voice1, R.drawable.record_voice2,
			R.drawable.record_voice3, R.drawable.record_voice4,R.drawable.record_voice5 };
	...
	public final static int   MAX_TIME =180;//一分钟
	...
	private void initDialogAndStartRecord() {
		...
		view.setImageResource(R.drawable.voice_record_anim);
	...
	private void finishRecord() {
		...
		if (intervalTime < MIN_INTERVAL_TIME) {
			...
			File file = new File(mFileName+".amr");
			file.delete();
			return;
		}

		if (finishedListener != null)
			finishedListener.onFinishedRecord(mFileName+".amr",(int) (intervalTime/1000));
	}
	...
	util = new AudioRecorder2Mp3Util(mFileName+".amr");
		util.startRecording();
	}
