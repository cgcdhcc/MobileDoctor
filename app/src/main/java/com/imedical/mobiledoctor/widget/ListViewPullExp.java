...
public class ListViewPullExp extends ExpandableListView implements OnScrollListener {
	...
	public ListViewPullExp(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public ListViewPullExp(Context context, AttributeSet attrs, int defStyle) {
...
//
	...
	public void stopLoadMore(Boolean haveMore){
